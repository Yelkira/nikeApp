        ...
        <section className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10">
            ...
            <div className='flex flex-1 flex-col'>
                <h2 className='font-palanquin text-4xl capitalize font-bold lg:max-w-lg'>
                    <span className="text-coral-red inline-block  mr-3">Special</span>
                    Offer
                </h2>
                ...
                <p className="mt-6 lg:max-w-lg info-text">Navigate a realm of possibilities designed to fulfill your
                    unique desires, surpassing the loftiest expectations. Your journey with us is nothing short of
                    exceptional.</p>
